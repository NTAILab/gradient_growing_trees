...
# Modified: Splitter, ParentInfo, StackRecord, Impurity handling
...
cdef inline void _init_parent_record(ParentInfo* record) noexcept nogil:
    ...
    # record.node_value = NULL  # 0
    record.tree_value = NULL
    record.tree_value_stride = 0
    record.node_id = 0
...
cdef class DepthFirstTreeBuilder(TreeBuilder):
    ...
    cpdef build(
        ...
        # parent_record.n_samples_in_node = n_node_samples
        ...
        with nogil:
            ...
            builder_stack.push({
                ...
                "n_samples_in_node": n_node_samples,
            })
            ...
            while not builder_stack.empty():
                ...
                # parent_record.node_value = stack_record.node_value  # !modification
                parent_record.node_id = stack_record.parent
                parent_record.tree_value = tree.value
                parent_record.tree_value_stride = tree.value_stride
                parent_record.n_samples_in_node = stack_record.n_samples_in_node

                n_node_samples = end - start
                # splitter.node_reset(start, end, &weighted_n_node_samples, parent_record.node_value)
                splitter.node_reset(start, end, &weighted_n_node_samples, &parent_record)
                ...
                #     print("parent_record.impurity:", parent_record.impurity)
